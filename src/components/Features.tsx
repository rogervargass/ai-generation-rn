    ...
    <View style={{height: hp(60) }} className='space-y-4'>
      ...
      <View className='bg-emerald-200 p-4 rounded-xl space-y-2'>
        ...
        <Text style={{fontSize: wp(3.8)}} className='font-medium text-gray-700'>
          ChatGPT can provide you with instant and knowledgeable responses, assist you with creative ideias on a wide range of topics.
        </Text>
      </View>

      <View className='bg-purple-200 p-4 rounded-xl space-y-2'>
        <View className='flex-row items-center space-x-1'>
          <Image source={require('../../assets/images/dall-e_icon.png')} style={{height: hp(4), width: hp(4) }} />
      ...
      <View className='bg-cyan-200 p-4 rounded-xl space-y-2'>
        <View className='flex-row items-center space-x-1'>
          <Image source={require('../../assets/images/smart-ai_logo.png')} style={{height: hp(4), width: hp(4) }} />
